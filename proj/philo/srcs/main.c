...
/*   Updated: 2026/05/29 21:26:24 by keitotak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "philo.h"

static int	create_fork(t_shared *shared)
{
...
{
	if (!is_positive_numbers(av) || is_overflow(av))
	...
	shared->time_to_think = shared->time_to_die - shared->time_to_eat
